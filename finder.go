...
func findARestaurant(mealType string, location string) {
	...
	foursquareClientId := "2PWUQCMZ2F4TWRSDNLM3NKRSP2CWDTS5RRXSF3CPBVMEB4N1"
	foursquareClientSecret := "W05U4CQ34JCY1RZM03PKSVBOSLGROMCGBI4JHH54E0NTYG1J"
	...
	for _, v := range data["response"].(map[string]interface{}) {
		...
		for _, v2 := range v.([]interface{}) {
			...
			Imgurl := "https://api.foursquare.com/v2/venues/" + id + "/photos?client_id=" + foursquareClientId + "&v=20150603&client_secret=" + foursquareClientSecret
...
func getGeocodeLocation(s string) (float64, float64) {
	googleApiKey := "AIzaSyCofmJ-ikS2mKnKwAZuzfVXKyhIiQbfylc"
...
func main() {
	...
	fmt.Println(getGeocodeLocation("Pune, India"))
